...
VALUES (1, 'AI 助手', 'jimu-ChatGPT', 'qwen2:7b');

insert into app_chat_plugin(id, name, icon, model,float_view)
VALUES (2, '编程助手', 'jimu-code', 'llama3:latest','ProgrammingAssistantPanelView');

insert into app_chat_plugin(id, name, icon, model, float_view)
VALUES (3, '知识库', 'jimu-zhishi', 'qwen2:7b', 'KnowledgePanelView');